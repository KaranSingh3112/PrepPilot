                    ...
                    <div className='flex items-center justify-between h-16'>
                        ...
                        <div className='flex items-center gap-4'>
                            <button
                                ...
                                className='md:hidden inline-flex items-center justify-center rounded-md p-2 text-slate-700 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-brand-500'
                            >
            ...
            {mobileMenuOpen && (
                <div className='md:hidden bg-white border-t border-slate-200'>
                    <div className='max-w-7xl mx-auto px-4 py-4 space-y-2'>
                        <Link to="/dashboard" onClick={() => setMobileMenuOpen(false)} className={`block px-3 py-2 rounded-md text-sm font-medium ${isActive('/dashboard')}`}>
                            Dashboard
                        </Link>
                        <Link to="/upload" onClick={() => setMobileMenuOpen(false)} className={`block px-3 py-2 rounded-md text-sm font-medium ${isActive('/upload')}`}>
                            New Interview
                        </Link>
                        <Link to="/history" onClick={() => setMobileMenuOpen(false)} className={`block px-3 py-2 rounded-md text-sm font-medium ${isActive('/history')}`}>
                            History
                        </Link>
                    </div>
                </div>
